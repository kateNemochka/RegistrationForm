...
public interface RegexPatterns {
    ...
    String SURNAME_PATTERN_UKR = "^[А-ЩЮЯ][а-щьюя'\\-]{0,18}[а-шьюя]$";

    String NAME_PATTERN_ENG = "^[A-Z][a-z]{1,20}$";
    String NAME_PATTERN_UKR = "^[А-ЩЮЯ][а-щьюя']{0,19}$";
    ...
    String PHONE_NUMBER_PATTERN = "^\\+\\d{1,3}\\s\\d{3}\\s\\d{3}\\s\\d{2}\\s\\d{2}$";
    ...
    String CITY_STREET_PATTERN_UKR = "^(([A-Z][a-z])?[A-Z][a-z]{1,20}\\s?)+$";
    String CITY_STREET_PATTERN_ENG = "^([А-ЩЮЯ][а-щьюя'\\-]{0,18}[а-шьюя]\\s?)+$";
    String HOUSE_NUMBER_UKR = "^\\d+[А-ЩЮЯ]?$";
    String HOUSE_NUMBER_ENG = "^\\d+[A-Z]?$";
    String APARTMENT_NUMBER_UKR = "^\\d+[А-ЩЮЯ]?$";
